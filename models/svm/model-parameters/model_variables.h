...
const char* ei_classifier_inferencing_categories[] = { "centre", "edge", "off", "on" };

uint8_t ei_dsp_config_12_axes[] = { 0, 1, 2 };
const uint8_t ei_dsp_config_12_axes_size = 3;
ei_dsp_config_spectral_analysis_t ei_dsp_config_12 = {
    12, // uint32_t blockId
    4, // int implementationVersion
    3, // int length of axes
    0.08170803149268f, // float scale-axes
    1, // int input-decimation-ratio
    "low", // select filter-type
    49.4140625f, // float filter-cutoff
    6, // int filter-order
...
const ei_impulse_t impulse_494253_0 = {
    .project_id = 494253,
    .project_owner = "motusml",
    .project_name = "vibration classification",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_494253_0 = ei_impulse_handle_t( &impulse_494253_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_494253_0;
